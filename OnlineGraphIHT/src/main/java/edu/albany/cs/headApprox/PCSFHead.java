 ...
 */
public class PCSFHead {

	/** 1. Graph G */
	private ArrayList<Integer[]> edges;
	/** 2. edge costs c (corresponding to edges) */
	 ...
	 * @param C
	 */
	public PCSFHead(ArrayList<Integer[]> edges, ArrayList<Double> c, ArrayList<Double> pi, int g, double C) {
	 ...
	 * @param B
	 */
	public PCSFHead(ArrayList<Integer[]> edges, ArrayList<Double> edgeCostsW, double[] b, int s, int g, double B,
			int[] trueSubGraph) {
